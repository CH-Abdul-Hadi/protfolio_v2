...
export const DEFAULT_USER = {
    NAME: import.meta.env.VITE_DEFAULT_NAME || 'Abdul Hadi',
    TITLE: import.meta.env.VITE_DEFAULT_TITLE || 'Full-Stack Developer',
    EMAIL: import.meta.env.VITE_DEFAULT_EMAIL || 'sadbulhadi016@gmail.com',
...
export const DEFAULT_SOCIAL = {
    GITHUB_URL: import.meta.env.VITE_DEFAULT_GITHUB_URL || 'https://github.com/CH-Abdul-Hadi',
    GITHUB_USERNAME: import.meta.env.VITE_DEFAULT_GITHUB_USERNAME || 'CH-Abdul-Hadi',
    LINKEDIN_URL: import.meta.env.VITE_DEFAULT_LINKEDIN_URL || 'www.linkedin.com/in/abdul-hadi-shahid',
    LINKEDIN_USERNAME: import.meta.env.VITE_DEFAULT_LINKEDIN_USERNAME || 'Abdul Hadi Shahid',
...
export const FORM_SETTINGS = {
    ...
    GOOGLE_FORM_URL: import.meta.env.VITE_GOOGLE_FORM_URL || 'https://docs.google.com/forms/d/e/1FAIpQLScmklpejT8NnsVai6JYpiORuJZoPn_ov5jzeVCpnYQNTzigOQ/viewform?usp=dialog',
    // Field IDs from the Google Form
    GOOGLE_FORM_NAME_FIELD: import.meta.env.VITE_GOOGLE_FORM_NAME_FIELD || 'entry.2005620554',
    GOOGLE_FORM_EMAIL_FIELD: import.meta.env.VITE_GOOGLE_FORM_EMAIL_FIELD || 'entry.1045781291',
    GOOGLE_FORM_MESSAGE_FIELD: import.meta.env.VITE_GOOGLE_FORM_MESSAGE_FIELD || 'entry.839337160'
};
